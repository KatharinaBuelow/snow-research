...
The bandwidth used is **`pi` = 95** (95% confidence interval).

| Script | Description |
|--------|-------------|
| `plot_timeseries_all_rcps_region.py` | Full Prudence region |
| `plot_timeseries_all_rcps_region_levels.py` | Per elevation level |
| `plot_timeseries_all_rcps_region_absolut.py` | Absolute values, full region |
| `plot_timeseries_all_rcps_region_levels_absolut.py` | Absolute values, per level |
...
| File | Purpose |
|------|---------|
| `colortable.py` | Color definitions for scenarios and models |
| `design_matrix_tool.py` | Data frame cleaning utility |
